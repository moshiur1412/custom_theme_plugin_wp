...
if ( $listing_id ) {
	...
	$latitude_key 	= esc_attr( isset( $field['name'] ) ? $field['name'] : $key ) . '__latitude';
	$longitude_key 	= esc_attr( isset( $field['name'] ) ? $field['name'] : $key ) . '__longitude';
	$latitude = isset( $_REQUEST[ $latitude_key ] ) ? sanitize_text_field( $_REQUEST[ $latitude_key ] ) : false;
	$longitude = isset( $_REQUEST[ $longitude_key ] ) ? sanitize_text_field( $_REQUEST[ $longitude_key ] ) : false;
}
