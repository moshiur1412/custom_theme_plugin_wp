	...
	if( !function_exists('limoking_regiser_use_script') ){
		function limoking_regiser_use_script($array){	
			...
			if( is_search() || is_archive() || 
				...
				$array['style']['limoking-flexslider'] = get_template_directory_uri() . '/plugins/flexslider/flexslider.css';
				$array['script']['limoking-flexslider'] = get_template_directory_uri() . '/plugins/flexslider/jquery.flexslider.js';
			}
